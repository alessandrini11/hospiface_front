...
const RoomTable = ({columns, newUrl, entities, page, pagination, handle_click}: Props) => {
    return (
        <div className="">
            <div className="card">
                <div className="card-header">
                    <h4 className="card-title mb-0 flex-grow-1">Chambres</h4>
                            ...
                            <tbody>
                                {entities.length > 0 ? entities.map((entity, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className="text-center">{entity.number}</td>
                                        <td className="text-center">{entity.beds}</td>
                                        ...
                                        <td>
                                            <div className="d-flex justify-content-between">
                                                ...
                                                <Link className='px-1' to={`${URLS.rooms.edit}/${entity.id}`}><FontAwesomeIcon icon={faPencil} /></Link>
