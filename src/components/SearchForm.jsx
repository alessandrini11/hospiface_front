  ...
  return (
    <form>   
        ...
        <div className="relative">
            ...
            <input type="search" name='query' className="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:border-blue-500" placeholder="Search"/>
